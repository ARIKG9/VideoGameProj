...
public class Item3{
	...
	public Item3(int x_coordinate, int y_coordinate, String imageString){
	...
	public Item3(int x_coordinate, int y_coordinate, String imageString, int imageScale){
	...
	// description: This method will return true if the Item collides with the parameter Item.
	// return: boolean - true if the two items intersect or collide with each other, otherwise false. 
	public boolean collision(Item3 otherItem) {
