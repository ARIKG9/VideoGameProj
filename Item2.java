...
public class Item2{
	...
	public Item2(int x_coordinate, int y_coordinate, String imageString){
	...
	public Item2(int x_coordinate, int y_coordinate, String imageString, int imageScale){
	...
	// description: This method will return true if the Item collides with the parameter Item.
	// return: boolean - true if the two items intersect or collide with each other, otherwise false. 
	public boolean collision(Item2 otherItem) {
	...
	public void move(Component c){
		...
		// move up or down
		if ((y_coordinate > 0 && y_direction == -1) || (y_coordinate < c.getHeight() && y_direction == 1 ))
